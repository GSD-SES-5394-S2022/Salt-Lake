...
#HBO
skims <- skims %>%
  mutate(n_transit_HBO = round(HBO_flows * p_transit_HBO),
         n_SOV_HBO = round(HBO_flows * p_SOV_HBO),
         n_HOV_HBO = round(HBO_flows * p_HOV_HBO),
         n_walk_HBO = round(HBO_flows * p_walk_HBO),
         n_bike_HBO = round(HBO_flows * p_bike_HBO)) %>%
...
#NHB
skims <- skims %>%
  mutate(n_transit_HBW= round(HBW_flows * p_transit_HBW),
         n_SOV_HBW = round(HBW_flows * p_SOV_HBW),
         n_HOV_HBW = round(HBW_flows * p_HOV_HBW),
         n_walk_HBW = round(HBW_flows * p_walk_HBW),
         n_bike_HBW = round(HBW_flows * p_bike_HBW)) %>%
...
#HB
skims <- skims %>%
  mutate(n_transit_NHB = round(NHB_flows * p_transit_NHB),
         n_SOV_NHB = round(NHB_flows * p_SOV_NHB),
         n_HOV_NHB = round(NHB_flows * p_HOV_NHB),
         n_walk_NHB = round(NHB_flows * p_walk_NHB),
         n_bike_NHB = round(NHB_flows * p_bike_NHB)) %>%
