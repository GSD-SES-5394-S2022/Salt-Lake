...
skims <- skims %>%
  ...
  mutate(p_SOV_HBW = p_SOV_if_car_HBW * p_car_HBW,
         ...
         p_walk_HBW = p_walk_if_active_HBW * p_active_HBW,
         p_bike_HBW = p_bike_if_active_HBW * p_active_HBW) %>%
  mutate(n_transit_HBO = round(HBO_flow * p_transit_HBW),
         n_SOV_HBO = round(HBW_flow * p_SOV_HBO),
         n_HOV_HBO = round(HBW_flow * p_HOV_HBO),
         n_walk_HBO = round(HBO_flow * p_walk_HBO),
         n_bike_HBO = round(HBO_flow * p_bike_HBO)) %>%
  replace_na(list(n_transit_HBO = 0,
                  n_SOV_HBO = 0,
...
model_compare2 <- rbind(model_compare, HBO_modeled_mode_by_purpose_1, modeled_mode_by_purpose_2) 
...
model_compare2 <- rbind(model_compare, HBW_modeled_mode_by_purpose_1, HBW_modeled_mode_by_purpose_2) 
...
model_compare2 <- rbind(model_compare, NHB_modeled_mode_by_purpose_2) 
...
map <- ggplot(zones) +
  ...
  scale_fill_gradientn(colours = map_palette,
                       name = "Percentage of bike mode \nin total HBO trip from the tract") +
  theme_void()

map
ggsave("images/HBO_fromid_mode_bike_exs.png",
...
map
ggsave("images/HBO_fromid_mode_walk_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
```{r}
map_palette <- brewer.pal(5, "PuBuGn")
...
map
ggsave("images/HBO_fromid_mode_transit_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
...
map
ggsave("images/HBO_fromid_mode_car_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
## HBW
```{r}
...
map <- ggplot(zones) +
  geom_sf(aes(fill = pct_bike),
          color = NA) +
  scale_fill_gradientn(colours = map_palette,
                       name = "Percentage of bike mode \nin total HBW trip from the tract") +
  theme_void()

map
ggsave("images/HBW_fromid_mode_bike_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/HBW_fromid_mode_walk_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/HBW_fromid_mode_transit_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/HBW_fromid_mode_car_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
...
map <- ggplot(zones) +
  geom_sf(aes(fill = pct_bike),
          color = NA) +
  scale_fill_gradientn(colours = map_palette,
                       name = "Percentage of bike mode \nin total NHB trip from the tract") +
  theme_void()

map
ggsave("images/NHB_fromid_mode_bike_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/NHB_fromid_mode_walk_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/NHB_fromid_mode_transit_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/NHB_fromid_mode_car_exs.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
