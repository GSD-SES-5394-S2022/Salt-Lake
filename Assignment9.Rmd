...
ggsave("images/HBO_mode_percentage.png",
...
ggsave("images/HBW_mode_percentage.png",
      width = 20, height = 9, units = "cm",dpi = 300)
```
...
ggsave("images/NHB_mode_percentage.png",
      width = 20, height = 9, units = "cm",dpi = 300)
```
...
map
ggsave("images/HBO_fromid_mode_bike.png",
...
map
ggsave("images/HBO_fromid_mode_walk.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
```{r}
map_palette <- brewer.pal(5, "PuBuGn")
...
map
ggsave("images/HBO_fromid_mode_transit.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
```{r}
map_palette <- brewer.pal(5, "PuBuGn")
...
map
ggsave("images/HBO_fromid_mode_car.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
## HBW
```{r}
...
map
ggsave("images/HBW_fromid_mode_bike.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/HBW_fromid_mode_walk.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/HBW_fromid_mode_transit.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/HBW_fromid_mode_car.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
...
map
ggsave("images/NHB_fromid_mode_bike.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/NHB_fromid_mode_walk.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/NHB_fromid_mode_transit.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/NHB_fromid_mode_car.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
