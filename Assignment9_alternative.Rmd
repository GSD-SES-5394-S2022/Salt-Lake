...
## HBW trips: We select Model H to estimate the mode shares, since our city has over 1 million population and our model includes non-motorized modes.
...
model_compare2 <- rbind(model_compare, NHB_modeled_mode_by_purpose_1, NHB_modeled_mode_by_purpose_2) 
...
ggplot(HBO_mode_tibble, aes(area = Percentage, fill= bucket)) +
...
ggsave("images/HBO_mode_percentagealtalt.png",
...
ggplot(HBW_mode_tibble, aes(area = Percentage, fill= bucket)) +
  geom_treemap(show.legend = FALSE) +
  geom_treemap_text(aes(label = paste(bucket, "\n",
                                      prettyNum(Percentage, digits = 0),
                                      "%",sep = "")), 
...
ggsave("images/HBW_mode_percentagealtalt.png",
      width = 20, height = 9, units = "cm",dpi = 300)
```
...
ggplot(NHB_mode_tibble, aes(area = Percentage, fill= bucket)) +
  geom_treemap(show.legend = FALSE) +
  geom_treemap_text(aes(label = paste(bucket, "\n",
                                      prettyNum(Percentage, digits = 0),
                                      "%",sep = "")), 
...
ggsave("images/NHB_mode_percentagealtalt.png",
      width = 20, height = 9, units = "cm",dpi = 300)
```
...
map
ggsave("images/HBO_fromid_mode_bikealtalt.png",
...
map
ggsave("images/HBO_fromid_mode_walkaltalt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
```{r}
map_palette <- brewer.pal(5, "PuBuGn")
...
map
ggsave("images/HBO_fromid_mode_transitaltalt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
```{r}
map_palette <- brewer.pal(5, "PuBuGn")
...
map
ggsave("images/HBO_fromid_mode_caraltalt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
## HBW
```{r}
...
map
ggsave("images/HBW_fromid_mode_bikealt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/HBW_fromid_mode_walkalt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/HBW_fromid_mode_transitalt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/HBW_fromid_mode_caralt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
...
map
ggsave("images/NHB_fromid_mode_bikealt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/NHB_fromid_mode_walkalt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/NHB_fromid_mode_transitalt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
...
map
ggsave("images/NHB_fromid_mode_caralt.png",
       width = 20, height = 15, units = "cm",dpi = 300)
```
