...
=======
          size = 0.1) +
>>>>>>> 5d8bb0b3ded1945a32e777e20f14e3acb0468db7
...
```{r}
inc_quint_20_df <- tibble(hh_size = rep("Under 35,000 ", 
                                      length(inc_quint_20_pts))) %>%
  st_sf(geom = inc_quint_20_pts)
                        
inc_quint_35_df <- tibble(hh_size = rep("35,000 - 60,000", 
                                      length(inc_quint_35_pts))) %>%
  st_sf(geom = inc_quint_35_pts)
 
inc_quint_60_df <- tibble(hh_size = rep("60,000 - 100,000", 
                                      length(inc_quint_60_pts))) %>%
  st_sf(geom = inc_quint_60_pts)

inc_quint_80_df <- tibble(hh_size = rep("100,000 - 150,000", 
                                      length(inc_quint_80_pts))) %>%
  st_sf(geom = inc_quint_80_pts)

inc_quint_100_df <- tibble(hh_size = rep("150,000 - $200,000", 
