...
```{r}
income_buckets <- c(sum(census$inc_quint_1)/sum(census$total_hhsE),sum(census$inc_quint_2)/sum(census$total_hhsE),sum(census$inc_quint_3)/sum(census$total_hhsE)) 
