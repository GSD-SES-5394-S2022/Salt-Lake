...
avg_hh_map <- ggplot(zones) +
  geom_sf(aes(fill = as.numeric(avg_hh_sizeE)), color="NA")
...
scale_fill_gradientn(colors = map_palette,  
                     name = "Average households size") 

ggsave("images/avg_hhsize_map.png",
       width = 40, height = 20, units = "mm",dpi = 300)
```
