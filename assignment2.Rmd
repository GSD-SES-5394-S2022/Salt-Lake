...
```{r}
census <- census %>% mutate(inc_quint_1 = inc_lt_10kE+inc_btw_10k_15kE+
        ...
        mutate(inc_quint_3 = inc_btw_60k_75kE + inc_btw_75k_100kE + 
        inc_btw_100k_125kE+inc_btw_125k_150kE+inc_btw_150k_200kE+inc_gt_200kE)%>%
 select(GEOID, 
         total_hhsE,
         no_vehE,
         hh_1personE,
