...
```{r}
income_buckets <- c(sum(census$inc_quint_1)/sum(census$total_hhsE),
sum(census$inc_quint_2)/sum(census$total_hhsE),sum(census$inc_quint_3)/sum(census$total_hhsE)) 
...
```{r}
hhsize_buckets <- c(sum(census$hh_1person)/sum(census$total_hhsE),sum(census$hh_2person)/sum(census$total_hhsE),sum(census$hh_3person)/sum(census$total_hhsE),sum(census$hh_4person_plus)/sum(census$total_hhsE)) 
